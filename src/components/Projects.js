      ...
      return (
        (<div
          ...
          <p
            ...
            <br/>As part of my final semester project, I developed a secure IoT-based system for monitoring and controlling embedded devices using modern technologies such as MQTT, SSL/TLS, and Node-RED. This project focuses on ensuring secure communication between IoT devices (ESP32), a Django backend server, and a real-time data visualization interface. The system is designed for applications requiring secure data transmission, real-time monitoring, and remote control of embedded systems.
          </p>
          <Image
            src="/cap1.png"
            alt=""
          ...
          <p
            ...
            <br/>- <strong>1- Secure IoT Communication: </strong><br/>    &nbsp;&nbsp; - Utilizes SSL/TLS encryption to secure data transmission between the ESP32 microcontroller and the Django server via the MQTT protocol.
            <br/>    &nbsp;&nbsp; - Prevents data interception and ensures the integrity and confidentiality of sensitive information.
            <br/>- <strong>2- Real-Time Data Monitoring: </strong><br/>    &nbsp;&nbsp; - Collects and displays real-time sensor data (temperature and humidity) on an interactive dashboard using Node-RED and Chart.js.
            <br/>    &nbsp;&nbsp; - Provides live updates and visualizations for better decision-making and system monitoring.
            <Image
            src="/cap3.png"
            alt=""
            height="500"
            width="500"
            className="pb-4 pt-4 md:w-1/2 md:h-1/2 h-full w-full mx-auto object-contain" /><br/>- <strong>3- Remote Control via MQTT:: </strong><br/>    &nbsp;&nbsp; - Allows users to send commands to the ESP32 (e.g., displaying text on an LCD) through a secure MQTT connection.
            <br/>    &nbsp;&nbsp; - Enables remote management and control of IoT devices from a centralized interface.
            
            <br/>- <strong>4- Simulation and Testing with Wokwi: </strong><br/>    &nbsp;&nbsp; - Uses Wokwi, an ESP32 simulator, to test and validate the system's functionality before physical implementation.
            <br/>    &nbsp;&nbsp; - Ensures the reliability and accuracy of the system in a controlled environment.
            <Image
            src="/cap2.png"
            alt=""
            height="500"
            width="500"
            className="pb-4 pt-4 md:w-1/2 md:h-1/2 h-full w-full mx-auto object-contain" />
            <br/>- <strong>5- User-Friendly Interface with Django: </strong><br/>    &nbsp;&nbsp; - Provides a web-based interface built with Django for managing and visualizing IoT data.
            <br/>    &nbsp;&nbsp; - Features include real-time charts, command logs, and user interaction capabilities.
            <Image
            src="/cap5.png"
            alt=""
            height="500"
            ...
            className="pb-4 pt-4 md:w-1/2 md:h-1/2 h-full w-full mx-auto object-contain" />
             <br/>
             <br/>This project successfully demonstrates the integration of modern IoT technologies to create a secure, scalable, and user-friendly system for monitoring and controlling embedded devices. By leveraging MQTT, SSL/TLS, and Node-RED, the system ensures secure communication, real-time data visualization, and remote control capabilities, making it suitable for various IoT applications in industrial, commercial, and domestic settings.
             <br/><br/>You can access the complete source code of the project on the following GitHub repository. Scan the QR code below to access it directly.
             <Image
            src="/cap6.png"
            alt=""
            height="500"
            ...
            className="pb-4 pt-4 md:w-1/2 md:h-1/2 h-full w-full mx-auto object-contain" />
             <br/>
              <a href="/Rapport projet fin de semestre PYTHON.pdf" download="Rapport projet fin de semestre PYTHON" className="text-blue-600 dark:text-blue-400 underline mt-4 block mx-auto text-center">
                Download the rapport for complete project details (PDF)
              </a>
          </p>
        </div>
...
const data = [
  ...
  },
  {
    ...
    title: "Securing Embedded Systems using SSL/TLS.",
    src: "/SSL.png",
    content: <Security />,
  },
];
